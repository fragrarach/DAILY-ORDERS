...
THEN
    ...
    THEN
        ...
        ELSIF
            (NEW.ord_pckslp_stat1 <> OLD.ord_pckslp_stat1 AND NEW.ord_pckslp_stat1 = 'F') OR
            (NEW.ord_pckslp_stat2 <> OLD.ord_pckslp_stat2 AND NEW.ord_pckslp_stat2 = 'F') OR
            (NEW.ord_pckslp_stat3 <> OLD.ord_pckslp_stat3 AND NEW.ord_pckslp_stat3 = 'F') OR
            (NEW.ord_pckslp_stat4 <> OLD.ord_pckslp_stat4 AND NEW.ord_pckslp_stat4 = 'F') AND
            NEW.ord_status <> 'I'
        THEN
            PERFORM pg_notify(
                'daily_orders', '['
